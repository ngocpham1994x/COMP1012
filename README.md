...
|**Format codes**<br />`7.3f`<br /> `^ ^^---  `<br />`| | `<br />`| ----- `<br />`| `<br />`-------`<br /> <br /><br /><br />`{data-index:formatcode}.format()`<br /><br />`{0:3d}.format(16)`<br />`{0:<4d}.format(16)`<br /><br />`{0:9.2e}.format(-6.123)`<br />`{0:<12.4e}.format(0.32)`<br /><br />`{0:7.2f}.format(-6.123)`<br />`{0:<8.4f}.format(0.32)`<br /><br />`{0:5s}.format("Hello")`<br />		|		<br /># floating point (type), 3 decimal places (precision)<br /><br /><br /><br /><br /># display up to 7 characters (width) <br /><br />	• type may be any of d (integer), e (floating exponent), f (floating point), or s (string) <br />	• width may be 0 or omitted entirely <br />	• precision may be 0 or omitted entirely<br /><br /># ' 16'<br /># '16  '<br /><br /># '-6.12e+00'<br /># '3.2000e-01  '<br /><br /># '  -6.12'<br /># '0.3200  '<br /><br /># 'Hello'<br />|
